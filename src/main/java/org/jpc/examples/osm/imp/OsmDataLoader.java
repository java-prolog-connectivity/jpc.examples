...
public class OsmDataLoader extends SaltPrologLoader {
			...
			DefaultHandler saxHandler = new DefaultHandler() {
				...
				public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
					if(qName.equals(NODE_ELEMENT)) {
						...
						writer.startCompound().startAtom(CoordinatesImp.COORDINATES_FUNCTOR).startAtom(lat).startAtom(lon).endCompound();
